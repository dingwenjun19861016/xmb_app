...
const FALLBACK_ARTICLE = {
  ...
  content: '自从SEC批准比特币现货ETF以来，资金持续流入市场。根据最新数据，上周共有超过10亿美元的新资金流入各大比特币ETF，其中贝莱德的IBIT吸引了约4.8亿美元。\n\n多位华尔街分析师认为，这种持续流入将推动比特币价格在未来几个月内突破历史新高。摩根士丹利的加密货币专家表示："机构资金正在逐步布局比特币市场，ETF为传统金融机构提供了一个合规的投资渠道。"\n\n有分析师预测比特币今年可能达到8万美元至10万美元的价格区间。',
  date: '1小时前',
  author: '币链快报',
  image: '', // 移除占位图片
  category: '市场动态',
