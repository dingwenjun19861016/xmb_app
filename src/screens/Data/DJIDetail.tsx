...
const DJIDetail: React.FC = () => {
  ...
  const renderGauge = () => {
    ...
    const color = '#007AFF';
    const progress = Math.min(Math.max(((value - 20000) / 20000) * 100, 0), 100); // 粗略范围 20000-60000
    return (
      <View style={styles.gaugeContainer}>
        <View style={styles.gaugeWrapper}>
          <View style={[styles.gaugeCircle, { borderColor: color }]}> 
            <Text style={[styles.gaugeValue, { color }]}>{DJIService.formatValue(value)}</Text>
          </View>
          <View style={styles.gaugeInfo}>
            ...
            <View style={styles.progressBarContainer}>
              ...
              <View style={styles.progressLabels}>
                <Text style={styles.progressLabel}>20000</Text>
                <Text style={styles.progressLabel}>区间</Text>
                <Text style={styles.progressLabel}>60000</Text>
              </View>
            </View>
          </View>
        </View>
